...
Diamond_json_1.default.abi = (0, utils_1.mergeABIs)([
                ...
                if (typeof options.deterministicSalt !== 'undefined') {
                    if (typeof options.deterministicSalt === 'string') {
                        if (options.deterministicSalt === salt) {
                            ...
                            expectedAddress = getCreate2Address(diamantaireContract.address, (0, solidity_1.keccak256)(['bytes32', 'address'], [salt, owner]), Diamond_json_1.default.bytecode +
