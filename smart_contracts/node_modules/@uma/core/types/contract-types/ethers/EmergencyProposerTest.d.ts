...
interface EmergencyProposerTestInterface extends ethers.utils.Interface {
  functions: {
...
export class EmergencyProposerTest extends BaseContract {
  ...
  interface: EmergencyProposerTestInterface;
