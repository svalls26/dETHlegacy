...
interface PerpetualLiquidatableInterface extends ethers.utils.Interface {
  functions: {
...
export class PerpetualLiquidatable extends BaseContract {
  ...
  interface: PerpetualLiquidatableInterface;
