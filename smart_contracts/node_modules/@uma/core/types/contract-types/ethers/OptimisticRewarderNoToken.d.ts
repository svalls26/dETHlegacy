...
interface OptimisticRewarderNoTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class OptimisticRewarderNoToken extends BaseContract {
  ...
  interface: OptimisticRewarderNoTokenInterface;
