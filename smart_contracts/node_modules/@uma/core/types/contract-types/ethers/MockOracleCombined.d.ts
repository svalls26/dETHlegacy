...
interface MockOracleCombinedInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getRequestParameters",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "pushPriceByRequestId",
    values: [BytesLike, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  events: {
    "PriceRequestAdded(address,bytes32,uint256,bytes,bytes32)": EventFragment;
    "PushedPrice(address,bytes32,uint256,bytes,int256,bytes32)": EventFragment;
  };
...
export class MockOracleCombined extends BaseContract {
  ...
  interface: MockOracleCombinedInterface;
  ...
  functions: {
    ...
    "pushPrice(bytes32,uint256,int256)"(
      identifier: BytesLike,
      time: BigNumberish,
      price: BigNumberish,
  ...
  filters: {
    "PriceRequestAdded(address,bytes32,uint256,bytes,bytes32)"(
    ...
    "PushedPrice(address,bytes32,uint256,bytes,int256,bytes32)"(
      pusher?: string | null,
      identifier?: BytesLike | null,
      time?: null,
      ancillaryData?: null,
