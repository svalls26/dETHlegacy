...
interface OwnerSelectOracleEscalationManagerInterface
  ...
  functions: {
    ...
    "setArbitrateViaSs(bool)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setArbitrateViaSs",
    values: [boolean]
  ): string;
  encodeFunctionData(
...
export class OwnerSelectOracleEscalationManager extends BaseContract {
  ...
  callStatic: {
    ...
    setArbitrateViaSs(value: boolean, overrides?: CallOverrides): Promise<void>;
