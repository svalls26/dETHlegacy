...
interface GovernorChildTunnelInterface extends ethers.utils.Interface {
  functions: {
...
export type ExecutedGovernanceTransactionEvent = TypedEvent<
  [string, string] & { to: string; data: string }
>;

export type MessageSentEvent = TypedEvent<[string] & { message: string }>;

export class GovernorChildTunnel extends BaseContract {
  ...
  interface: GovernorChildTunnelInterface;
  ...
  filters: {
    "ExecutedGovernanceTransaction(address,bytes)"(
      to?: string | null,
      data?: null
