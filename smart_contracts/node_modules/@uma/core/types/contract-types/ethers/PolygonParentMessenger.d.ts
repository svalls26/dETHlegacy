...
interface PolygonParentMessengerInterface extends ethers.utils.Interface {
  functions: {
...
export class PolygonParentMessenger extends BaseContract {
  ...
  interface: PolygonParentMessengerInterface;
