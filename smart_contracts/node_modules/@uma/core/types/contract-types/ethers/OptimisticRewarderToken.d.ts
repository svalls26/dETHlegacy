...
interface OptimisticRewarderTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class OptimisticRewarderToken extends BaseContract {
  ...
  interface: OptimisticRewarderTokenInterface;
