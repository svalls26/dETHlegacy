...
interface FlooredLinearLongShortPairFinancialProductLibraryInterface
  extends ethers.utils.Interface {
  functions: {
    "longShortPairParameters(address)": FunctionFragment;
    "percentageLongCollateralAtExpiry(int256)": FunctionFragment;
    "setLongShortPairParameters(address,int256,int256,uint256)": FunctionFragment;
  };
...
export class FlooredLinearLongShortPairFinancialProductLibrary extends BaseContract {
