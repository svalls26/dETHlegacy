...
interface WhitelistAsserterEscalationManagerInterface
  extends ethers.utils.Interface {
  functions: {
    "assertingCaller()": FunctionFragment;
    ...
    "setAsserterInWhitelist(address,bool)": FunctionFragment;
    "setAssertingCaller(address)": FunctionFragment;
    "transferOwnership(address)": FunctionFragment;
    "whitelistedAsserters(address)": FunctionFragment;
  };

  encodeFunctionData(
    functionFragment: "assertingCaller",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setAsserterInWhitelist",
    values: [string, boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "setAssertingCaller",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  events: {
    "AssertingCallerSet(address)": EventFragment;
    "OwnershipTransferred(address,address)": EventFragment;
    "PriceRequestAdded(bytes32,uint256,bytes)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "AssertingCallerSet"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "PriceRequestAdded"): EventFragment;
}

export type AssertingCallerSetEvent = TypedEvent<
  [string] & { assertingCaller: string }
>;
...
export class WhitelistAsserterEscalationManager extends BaseContract {
  ...
  functions: {
    assertingCaller(overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    "AssertingCallerSet(address)"(
      assertingCaller?: string | null
    ): TypedEventFilter<[string], { assertingCaller: string }>;
  ...
  estimateGas: {
    assertingCaller(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    assertingCaller(overrides?: CallOverrides): Promise<PopulatedTransaction>;
