...
interface MockOracleGovernanceInterface extends ethers.utils.Interface {
  functions: {
...
export class MockOracleGovernance extends BaseContract {
  ...
  interface: MockOracleGovernanceInterface;
