...
interface OracleGovernanceInterfaceInterface extends ethers.utils.Interface {
  functions: {
...
export class OracleGovernanceInterface extends BaseContract {
  ...
  interface: OracleGovernanceInterfaceInterface;
