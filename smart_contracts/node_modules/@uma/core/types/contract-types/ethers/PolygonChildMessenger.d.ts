...
interface PolygonChildMessengerInterface extends ethers.utils.Interface {
  functions: {
...
export class PolygonChildMessenger extends BaseContract {
  ...
  interface: PolygonChildMessengerInterface;
