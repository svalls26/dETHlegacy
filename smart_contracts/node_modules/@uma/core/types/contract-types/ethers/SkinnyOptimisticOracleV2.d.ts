...
interface SkinnyOptimisticOracleV2Interface extends ethers.utils.Interface {
  functions: {
...
export class SkinnyOptimisticOracleV2 extends BaseContract {
  ...
  interface: SkinnyOptimisticOracleV2Interface;
