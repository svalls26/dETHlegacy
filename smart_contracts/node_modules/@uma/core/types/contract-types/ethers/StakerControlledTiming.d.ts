...
interface StakerControlledTimingInterface extends ethers.utils.Interface {
  functions: {
...
export class StakerControlledTiming extends BaseContract {
  ...
  interface: StakerControlledTimingInterface;
