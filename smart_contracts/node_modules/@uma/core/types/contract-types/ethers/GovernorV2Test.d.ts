...
interface GovernorV2TestInterface extends ethers.utils.Interface {
  functions: {
    "addMember(uint256,address)": FunctionFragment;
    "emergencyExecute((address,uint256,bytes))": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [{ to: string; value: BigNumberish; data: BytesLike }[], BytesLike]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "EmergencyExecution(address,uint256,bytes)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "EmergencyExecution"): EventFragment;
...
export type EmergencyExecutionEvent = TypedEvent<
  [string, BigNumber, string] & { to: string; value: BigNumber; data: string }
>;
...
export class GovernorV2Test extends BaseContract {
  ...
  interface: GovernorV2TestInterface;
  ...
  functions: {
    ...
    emergencyExecute(
      transaction: { to: string; value: BigNumberish; data: BytesLike },
    ...
    proposals(
      ...
      [BigNumber, string] & { requestTime: BigNumber; ancillaryData: string }
    >;
  ...
  filters: {
    ...
    "EmergencyExecution(address,uint256,bytes)"(
      to?: string | null,
      value?: null,
      data?: null
    ): TypedEventFilter<
