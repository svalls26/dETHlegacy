...
interface VotingInterface extends ethers.utils.Interface {
  functions: {
    ...
    "snapshotMessageHash()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "gatPercentage",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "rewardsExpirationTimeout",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "snapshotMessageHash",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class Voting extends BaseContract {
  ...
  functions: {
    ...
    snapshotMessageHash(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    snapshotMessageHash(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    gatPercentage(overrides?: CallOverrides): Promise<PopulatedTransaction>;
