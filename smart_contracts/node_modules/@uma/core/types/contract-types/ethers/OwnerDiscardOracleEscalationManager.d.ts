...
interface OwnerDiscardOracleEscalationManagerInterface
  ...
  functions: {
    ...
    "setDiscardOracle(bool)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setDiscardOracle",
    values: [boolean]
  ): string;
  encodeFunctionData(
...
export class OwnerDiscardOracleEscalationManager extends BaseContract {
  ...
  callStatic: {
    ...
    setDiscardOracle(value: boolean, overrides?: CallOverrides): Promise<void>;
