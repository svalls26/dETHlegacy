...
export interface OptimisticOracleV2 extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
    options?: ContractOptions
  ): OptimisticOracleV2;
  clone(): OptimisticOracleV2;
  methods: {
    OO_ANCILLARY_DATA_LIMIT(): NonPayableTransactionObject<string>;

    TOO_EARLY_RESPONSE(): NonPayableTransactionObject<string>;
    ...
    requests(arg0: string | number[]): NonPayableTransactionObject<{
      proposer: string;
      disputer: string;
      currency: string;
      settled: boolean;
      ...
      2: string;
      3: boolean;
      4: [boolean, boolean, boolean, boolean, boolean, string, string];
      5: string;
      6: string;
      7: string;
      8: string;
