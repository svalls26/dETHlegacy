...
export interface OptimisticOracleV3 extends BaseContract {
  ...
  methods: {
    ...
    assertions(arg0: string | number[]): NonPayableTransactionObject<{
      ...
      callbackRecipient: string;
      disputer: string;
      0: [boolean, boolean, boolean, string, string];
      1: string;
      2: string;
      3: boolean;
      4: string;
    ...
    burnedBondPercentage(): NonPayableTransactionObject<string>;

    cachedCurrencies(arg0: string): NonPayableTransactionObject<{
    ...
    cachedOracle(): NonPayableTransactionObject<string>;
    ...
    setAdminProperties(
      ...
      _defaultLiveness: number | string | BN,
      _burnedBondPercentage: number | string | BN
    ): NonPayableTransactionObject<void>;
