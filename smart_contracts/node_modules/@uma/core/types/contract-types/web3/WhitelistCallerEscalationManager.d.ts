...
export interface WhitelistCallerEscalationManager extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
    options?: ContractOptions
  ): WhitelistCallerEscalationManager;
  clone(): WhitelistCallerEscalationManager;
  methods: {
