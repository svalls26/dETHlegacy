...
export interface OwnerDiscardOracleEscalationManager extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
    options?: ContractOptions
  ): OwnerDiscardOracleEscalationManager;
  clone(): OwnerDiscardOracleEscalationManager;
  methods: {
    ...
    setDiscardOracle(value: boolean): NonPayableTransactionObject<void>;
