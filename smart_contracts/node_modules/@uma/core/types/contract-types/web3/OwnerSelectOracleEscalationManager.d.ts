...
export interface OwnerSelectOracleEscalationManager extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
    options?: ContractOptions
  ): OwnerSelectOracleEscalationManager;
  clone(): OwnerSelectOracleEscalationManager;
  methods: {
    ...
    setArbitrateViaSs(value: boolean): NonPayableTransactionObject<void>;
