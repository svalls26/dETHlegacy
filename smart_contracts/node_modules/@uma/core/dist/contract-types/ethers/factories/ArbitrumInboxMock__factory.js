...
exports.ArbitrumInboxMock__factory = void 0;
...
class ArbitrumInboxMock__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (args.length === 1) {
...
exports.ArbitrumInboxMock__factory = ArbitrumInboxMock__factory;
