...
interface BobaAddressManagerInterface extends ethers.utils.Interface {
  functions: {
...
export class BobaAddressManager extends BaseContract {
  ...
  interface: BobaAddressManagerInterface;
