...
interface SkinnyOptimisticOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class SkinnyOptimisticOracle extends BaseContract {
  ...
  interface: SkinnyOptimisticOracleInterface;
