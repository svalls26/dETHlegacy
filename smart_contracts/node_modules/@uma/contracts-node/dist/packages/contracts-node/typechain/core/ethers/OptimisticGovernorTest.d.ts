...
interface OptimisticGovernorTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setTimer(address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "setTimer", values: [string]): string;
  ...
  decodeFunctionResult(functionFragment: "setTimer", data: BytesLike): Result;
...
export class OptimisticGovernorTest extends BaseContract {
  ...
  interface: OptimisticGovernorTestInterface;
  ...
  callStatic: {
    ...
    setTimer(_timerAddress: string, overrides?: CallOverrides): Promise<void>;
