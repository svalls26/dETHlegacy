...
interface ArbitrumBridgeMockInterface extends ethers.utils.Interface {
  functions: {
    "activeOutbox()": FunctionFragment;
    "outbox()": FunctionFragment;
    "processMessageFromCrossChainChild(address,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "processMessageFromCrossChainChild",
...
export class ArbitrumBridgeMock extends BaseContract {
  ...
  interface: ArbitrumBridgeMockInterface;
