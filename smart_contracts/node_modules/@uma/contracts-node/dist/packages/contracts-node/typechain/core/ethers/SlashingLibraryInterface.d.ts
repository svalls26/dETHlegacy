...
interface SlashingLibraryInterfaceInterface extends ethers.utils.Interface {
  functions: {
...
export class SlashingLibraryInterface extends BaseContract {
  ...
  interface: SlashingLibraryInterfaceInterface;
