...
interface StakerTestInterface extends ethers.utils.Interface {
  functions: {
    "applySlashingToCumulativeStaked(address,int128)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "applySlashingToCumulativeStaked",
...
export class StakerTest extends BaseContract {
  ...
  interface: StakerTestInterface;

  functions: {
    applySlashingToCumulativeStaked(
      voter: string,
      amount: BigNumberish,
