...
interface TestModuleProxyFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class TestModuleProxyFactory extends BaseContract {
  ...
  interface: TestModuleProxyFactoryInterface;
