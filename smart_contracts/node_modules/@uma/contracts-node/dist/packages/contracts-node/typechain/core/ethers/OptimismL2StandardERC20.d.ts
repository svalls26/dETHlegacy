...
interface OptimismL2StandardERC20Interface extends ethers.utils.Interface {
  functions: {
...
export class OptimismL2StandardERC20 extends BaseContract {
  ...
  interface: OptimismL2StandardERC20Interface;
