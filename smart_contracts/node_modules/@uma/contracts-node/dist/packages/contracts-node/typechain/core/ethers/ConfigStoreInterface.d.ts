...
interface ConfigStoreInterfaceInterface extends ethers.utils.Interface {
  functions: {
...
export class ConfigStoreInterface extends BaseContract {
  ...
  interface: ConfigStoreInterfaceInterface;
