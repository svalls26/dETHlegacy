...
interface ExpiringMultiPartyInterface extends ethers.utils.Interface {
  functions: {
    ...
    "transformCollateralRequirement((uint256))": FunctionFragment;
...
export class ExpiringMultiParty extends BaseContract {
  ...
  interface: ExpiringMultiPartyInterface;
