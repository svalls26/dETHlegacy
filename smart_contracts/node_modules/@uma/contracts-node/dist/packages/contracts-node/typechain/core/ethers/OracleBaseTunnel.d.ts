...
interface OracleBaseTunnelInterface extends ethers.utils.Interface {
  functions: {
...
export class OracleBaseTunnel extends BaseContract {
  ...
  interface: OracleBaseTunnelInterface;
