...
interface OptimismL2StandardBridgeInterface extends ethers.utils.Interface {
  functions: {
...
export class OptimismL2StandardBridge extends BaseContract {
  ...
  interface: OptimismL2StandardBridgeInterface;
