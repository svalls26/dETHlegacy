...
interface StakeableInterface extends ethers.utils.Interface {
  functions: {
    "addMember(uint256,address)": FunctionFragment;
    "executeUnstake(address)": FunctionFragment;
    ...
    "requestUnstake(uint128,address)": FunctionFragment;
    "resetMember(uint256,address)": FunctionFragment;
    "stake(uint128,address)": FunctionFragment;
...
export class Stakeable extends BaseContract {
