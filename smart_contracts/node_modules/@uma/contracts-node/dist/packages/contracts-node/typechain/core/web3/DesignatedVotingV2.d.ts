...
export interface DesignatedVotingV2 extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
    options?: ContractOptions
  ): DesignatedVotingV2;
  clone(): DesignatedVotingV2;
  methods: {
    addMember(
    ...
    delegateToVoter(): NonPayableTransactionObject<void>;

    executeUnstake(votingContract: string): NonPayableTransactionObject<void>;
