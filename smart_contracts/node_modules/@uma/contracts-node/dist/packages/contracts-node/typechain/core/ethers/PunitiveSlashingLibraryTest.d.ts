...
interface PunitiveSlashingLibraryTestInterface extends ethers.utils.Interface {
  functions: {
...
export class PunitiveSlashingLibraryTest extends BaseContract {
  ...
  interface: PunitiveSlashingLibraryTestInterface;
