...
interface OptimisticRewarderTestInterface extends ethers.utils.Interface {
  functions: {
...
export class OptimisticRewarderTest extends BaseContract {
  ...
  interface: OptimisticRewarderTestInterface;
