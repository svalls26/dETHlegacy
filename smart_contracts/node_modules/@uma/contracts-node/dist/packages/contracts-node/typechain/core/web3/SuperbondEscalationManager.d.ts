...
export interface SuperbondEscalationManager extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
    options?: ContractOptions
  ): SuperbondEscalationManager;
  clone(): SuperbondEscalationManager;
  methods: {
    ...
    superbond(): NonPayableTransactionObject<string>;

    superbondCurrency(): NonPayableTransactionObject<string>;
