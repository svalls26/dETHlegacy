...
(0, config_1.task)("check-price", "Check whether price has resolved for Oracle and return price")
    .addParam("oracle", "OracleInterface implementation address to check", undefined, config_1.types.string)
    .addParam("identifier", "Request identifier", undefined, config_1.types.string)
    .addParam("timestamp", "Request timestamp", undefined, config_1.types.string)
    .addParam("ancillary", "Request ancillary data", undefined, config_1.types.string)
