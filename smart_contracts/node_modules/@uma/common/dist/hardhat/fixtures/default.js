...
exports.runDefaultFixture = void 0;
...
async function runDefaultFixture({ deployments }, runInitialDeployment = true) {
    const setup = deployments.createFixture(async (hre) => {
        ...
        await addToFinder("Voting", Constants_1.interfaceName.Oracle);
        ...
        await addToFinder("OptimisticOracle", Constants_1.interfaceName.OptimisticOracle);
        await addToFinder("OptimisticOracleV2", Constants_1.interfaceName.OptimisticOracleV2);
        await addToFinder("SkinnyOptimisticOracle", Constants_1.interfaceName.SkinnyOptimisticOracle);
        await addToFinder("Bridge", Constants_1.interfaceName.Bridge);
        await addToFinder("GenericHandler", Constants_1.interfaceName.GenericHandler);
        // Setup token.
        ...
        await registry.methods.addMember(Enums_1.RegistryRolesEnum.CONTRACT_CREATOR, empCreatorAddress).send({ from: deployer });
        await registry.methods.addMember(Enums_1.RegistryRolesEnum.CONTRACT_CREATOR, perpCreatorAddress).send({ from: deployer });
...
exports.runDefaultFixture = runDefaultFixture;
