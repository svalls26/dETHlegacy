...
exports.UMA_FIRST_EMP_BLOCK = exports.ZERO_ADDRESS = exports.MAX_SAFE_JS_INT = exports.MAX_SAFE_ALLOWANCE = exports.MIN_INT_VALUE = exports.MAX_UINT_VAL = exports.BATCH_MAX_RETRIEVALS = exports.BATCH_MAX_REVEALS = exports.BATCH_MAX_COMMITS = exports.getMulticallAddress = exports.interfaceName = void 0;
...
const getMulticallAddress = (netId) => {
    // Most Multicall2 addresses are the same except for some edge cases which cause this function to return early
    if (!NETWORKS_WITH_MULTICALL_DEPLOYMENTS.includes(netId))
        throw new Error("No Multicall2 deployment for netId");
    if (netId == 10)
        return "0x35A6Cdb2C9AD4a45112df4a04147EB07dFA01aB7";
    if (netId == 100)
        return "0xb5b692a88bdfc81ca69dcb1d924f59f0413a602a";
    if (netId == 9001)
        return "0x95C2D32fDb32EDA8ce7fbF6539Dd6945acb9bB09";
...
exports.BATCH_MAX_COMMITS = 25;
exports.BATCH_MAX_REVEALS = 25;
exports.BATCH_MAX_RETRIEVALS = 100;
// maximum uint256 value: 2^256 - 1
exports.MAX_UINT_VAL = "115792089237316195423570985008687907853269984665640564039457584007913129639935";
// minimum int256 value: -2^255
exports.MIN_INT_VALUE = "-57896044618658097711785492504343953926634992332820282019728792003956564819968";
// maximum allowance allowed by certain ERC20's like UNI: 2^96 - 1
exports.MAX_SAFE_ALLOWANCE = "79228162514264337593543950335";
// Max integer that can be safely stored in a vanilla js int.
exports.MAX_SAFE_JS_INT = 2147483647;
...
exports.UMA_FIRST_EMP_BLOCK = 10103723;
