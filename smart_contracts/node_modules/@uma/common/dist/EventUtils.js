...
exports.getPaginatedBlockRanges = exports.paginatedEventQuery = void 0;
const bluebird_1 = require("bluebird");
const defaultConcurrency = 200;
const maxRetries = 3;
const retrySleepTime = 10;
function delay(s) {
    return new bluebird_1.Promise((resolve) => setTimeout(resolve, s * 1000));
}
async function paginatedEventQuery(contract, filter, searchConfig, retryCount = 0) {
    ...
    try {
        return (await bluebird_1.Promise.map(paginatedRanges, ([fromBlock, toBlock]) => contract.queryFilter(filter, fromBlock, toBlock), {
