...
exports.isPublicNetwork = exports.PublicNetworks = exports.getBridgeChainId = void 0;
...
function isPublicNetwork(name) {
    return Object.values(exports.PublicNetworks).some((network) => name.startsWith(network.name));
}
