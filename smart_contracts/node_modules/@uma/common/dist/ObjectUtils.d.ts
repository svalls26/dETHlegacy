 ...
 */
export declare const createObjectFromDefaultProps: (overrideProps: ObjectType, defaultProps: ObjectType) => ObjectType;
/**
 ...
 */
export declare const objectMap: <T extends Record<string, unknown>, U>(object: T, mapFn: (arg: T[keyof T]) => U) => { [Property in keyof T]: U; };
export {};
