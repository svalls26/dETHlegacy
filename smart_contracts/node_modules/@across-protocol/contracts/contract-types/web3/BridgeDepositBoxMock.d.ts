...
export type SetBridgeAdmin = ContractEventLog<{
  newBridgeAdmin: string;
  0: string;
}>;
...
export interface BridgeDepositBoxMock extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
    options?: ContractOptions
  ): BridgeDepositBoxMock;
  clone(): BridgeDepositBoxMock;
  methods: {
    ...
    setMinimumBridgingDelay(
      _minimumBridgingDelay: number | string | BN
    ): NonPayableTransactionObject<void>;
  ...
  events: {
    ...
    SetBridgeAdmin(cb?: Callback<SetBridgeAdmin>): EventEmitter;
    SetBridgeAdmin(
      options?: EventOptions,
      cb?: Callback<SetBridgeAdmin>
    ): EventEmitter;
  ...
  once(event: "SetBridgeAdmin", cb: Callback<SetBridgeAdmin>): void;
  once(
    event: "SetBridgeAdmin",
    options: EventOptions,
    cb: Callback<SetBridgeAdmin>
  ): void;
