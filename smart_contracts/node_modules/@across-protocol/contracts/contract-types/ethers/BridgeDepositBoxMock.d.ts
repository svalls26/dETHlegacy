...
interface BridgeDepositBoxMockInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "SetBridgeAdmin(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "SetBridgeAdmin"): EventFragment;
...
export class BridgeDepositBoxMock extends BaseContract {
  ...
  interface: BridgeDepositBoxMockInterface;
  ...
  filters: {
    ...
    SetBridgeAdmin(
      newBridgeAdmin?: null
    ): TypedEventFilter<[string], { newBridgeAdmin: string }>;
