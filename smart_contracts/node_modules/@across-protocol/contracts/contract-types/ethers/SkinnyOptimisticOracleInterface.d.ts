...
interface SkinnyOptimisticOracleInterfaceInterface
  ...
  functions: {
    ...
    "disputePrice(address,bytes32,uint32,bytes,tuple)": FunctionFragment;
    "disputePriceFor(bytes32,uint32,bytes,tuple,address,address)": FunctionFragment;
    "getState(address,bytes32,uint32,bytes,tuple)": FunctionFragment;
    "hasPrice(address,bytes32,uint32,bytes,tuple)": FunctionFragment;
    "proposePrice(address,bytes32,uint32,bytes,tuple,int256)": FunctionFragment;
    "proposePriceFor(address,bytes32,uint32,bytes,tuple,address,int256)": FunctionFragment;
    ...
    "settle(address,bytes32,uint32,bytes,tuple)": FunctionFragment;
