...
import type {
  ArbitrumBridgeMock,
  ArbitrumBridgeMockInterface,
} from "../ArbitrumBridgeMock";
...
export class ArbitrumBridgeMock__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(overrides || {}) as Promise<ArbitrumBridgeMock>;
  }
  ...
  attach(address: string): ArbitrumBridgeMock {
    return super.attach(address) as ArbitrumBridgeMock;
  }
  connect(signer: Signer): ArbitrumBridgeMock__factory {
    return super.connect(signer) as ArbitrumBridgeMock__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): ArbitrumBridgeMockInterface {
    return new utils.Interface(_abi) as ArbitrumBridgeMockInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ArbitrumBridgeMock {
    return new Contract(address, _abi, signerOrProvider) as ArbitrumBridgeMock;
  }
}
