...
import type {
  ...
  BridgeAdminInterfaceInterface,
} from "../BridgeAdminInterface";
...
export class BridgeAdminInterface__factory {
  static readonly abi = _abi;
  static createInterface(): BridgeAdminInterfaceInterface {
    return new utils.Interface(_abi) as BridgeAdminInterfaceInterface;
  }
  static connect(
    address: string,
