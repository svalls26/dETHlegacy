...
interface ArbitrumInboxMockInterface extends ethers.utils.Interface {
  functions: {
...
export class ArbitrumInboxMock extends BaseContract {
  ...
  interface: ArbitrumInboxMockInterface;
